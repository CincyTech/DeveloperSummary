...
function checkNumeric(objName) {
  var newObjName = objName.replace('$', '');
...
var colors = ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)', 'rgba(255, 159, 64, 0.2)', 'rgba(255, 159, 64, 0.6)'];
...
exports.standardizeCompanySize = standardizeCompanySize;
exports.standardizeExperience = standardizeExperience;
...
})(_answers2.default, _helpers.checkNumeric, _helpers.standardizeExperience, _helpers.standardizeCompanySize);
},{"./answers":1,"./helpers":2}]},{},[3]);
